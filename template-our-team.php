 			...
 			<div class="row">
 				<div class="col-md-6 col-lg-3 ftco-animate">
 					<div class="staff">
 						...
 						<div class="text pt-3 text-center team-des">
 							<h3>Bianca Wilson</h3>
 							<span class="position mb-2 desg-marg">Teacher</span>
 							<span class="contact-no">9852029337 / 9815245678</span>
 							<div class="faded">
 				...
 				<div class="col-md-6 col-lg-3 ftco-animate">
 					<div class="staff">
 						...
 						<div class="text pt-3 text-center team-des">
 							<h3>Mitch Parker</h3>
 							<span class="position mb-2 desg-marg">English Teacher</span>
 							<span class="contact-no">9852029337 / 9815245678</span>
 							<div class="faded">
 								<p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
 								<ul class="ftco-social text-center">
 				...
 				<div class="col-md-6 col-lg-3 ftco-animate">
 					<div class="staff">
 						...
 						<div class="text pt-3 text-center team-des">
 							<h3>Stella Smith</h3>
 							<span class="position mb-2 desg-marg">Art Teacher</span>
 							<span class="contact-no">9852029337 / 9815245678</span>
 							<div class="faded">
 								<p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
 								<ul class="ftco-social text-center">
 				...
 				<div class="col-md-6 col-lg-3 ftco-animate">
 					<div class="staff">
 						...
 						<div class="text pt-3 text-center team-des">
 							...
 							<span class="position mb-2 desg-marg">Science Teacher</span>
 							<span class="contact-no">9852029337 / 9815245678</span>
 							<div class="faded">
 								<p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
 								<ul class="ftco-social text-center">
